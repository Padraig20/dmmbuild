...
/*****************************************************************
 * 1. The f4_MSVFilter() DP implementation.
 *****************************************************************/
 
/* Function:  f4_MSVFilter()
 ...
 */
int
f4_MSVFilter(const ESL_DSQ *dsq, int L, const F4_OPROFILE *om, F4_OMX *ox, float *ret_sc)
{
  ...
  status = f4_SSVFilter(dsq, L, om, ret_sc);
